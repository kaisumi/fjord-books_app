  ...
  test 'should create user_detail' do
    assert_difference('UserDetail.count') do
      post user_details_url,
           params: { user_detail: { address: @user_detail.address, id: @user_detail.id, postal_code: @user_detail.postal_code,
                                    self_introduction: @user_detail.self_introduction, user_id: @user_detail.user_id, user_name: @user_detail.user_name } }
    end
